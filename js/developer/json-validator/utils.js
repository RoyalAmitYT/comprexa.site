/**
 * JSON Validator Utilities (Independent Implementation)
 * Provides toast messages, clipboard operations, file download, and byte formatting.
 */
...
export class ValidatorUtils {
  ...
  static downloadFile(text, filename = "validated.json") {
    if (!text) {
