/**
 * JSON Minifier Utilities
 * Toast notifications, clipboard operations, file download, and byte size formatting.
 */
...
export class MinifierUtils {
  ...
  static downloadFile(text, filename = "minified.json") {
    if (!text) {
    ...
    this.showToast("Minified JSON downloaded!", "success");
  }
