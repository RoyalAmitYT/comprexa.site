/**
 * JSON ↔ YAML Converter Utilities
 * Toast notifications, clipboard operations, file download, and byte formatting.
 */
...
export class ConverterUtils {
  ...
  static downloadFile(text, filename = "converted.yaml") {
    if (!text) {
