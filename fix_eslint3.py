...
# Special fixes for missing ones
...
replace_in_file('js/image-engine.js', r'import { ImageEngineEvents, ImageEventBus', r'import { ImageEngineEvents')
replace_in_file('js/image-engine.js', r'ImageErrorCategory, ImageErrorManager', r'ImageErrorCategory')
replace_in_file('js/image-engine.js', r'ImageProgressState, GlobalImageProgressManager', r'ImageProgressState')
replace_in_file('js/image-engine.js', r'BatchItemStatus, GlobalBatchProcessingManager', r'BatchItemStatus')

replace_in_file('js/image/engine.js', r'import { ImageEngineEvents, ImageEventBus', r'import { ImageEngineEvents')
replace_in_file('js/image/engine.js', r'import { ImageErrorCategory', r'// import { ImageErrorCategory')
replace_in_file('js/image/engine.js', r'import { ImageEngineError', r'// import { ImageEngineError')
replace_in_file('js/image/engine.js', r'ImageMetadataExtractor, GlobalImageMetadataExtractor', r'ImageMetadataExtractor')
replace_in_file('js/image/engine.js', r'import { ImageLoader }', r'// import { ImageLoader }')
replace_in_file('js/image/engine.js', r'CanvasProcessingEngine, GlobalCanvasProcessingEngine', r'CanvasProcessingEngine')
replace_in_file('js/image/engine.js', r'BatchItemStatus, GlobalBatchProcessingManager', r'BatchItemStatus')
replace_in_file('js/image/engine.js', r'import { BatchItemStatus', r'// import { BatchItemStatus')
replace_in_file('js/image/engine.js', r'import { ImageErrorManager, GlobalImageErrorManager', r'// import { ImageErrorManager, GlobalImageErrorManager')
